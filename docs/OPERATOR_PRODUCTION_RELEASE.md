...
2026-09-21 已生成后续连接器 0.1.2，增加共用电脑身份边界提示，不扩大工具或业务权限。候选包 `work/SACSI-operator-0.1.2-candidate.zip`，SHA-256：`c26fc7d50917866ea6f1f1ecaadeabdba9857baed106422bbd1fe3fbc5a54021`；已在 Chouke 当前电脑完成完整性、MCP、普通账号能力及真实订单只读查询，未执行收款。0.1.1 保留为历史回退包，不再作为新安装首选。
