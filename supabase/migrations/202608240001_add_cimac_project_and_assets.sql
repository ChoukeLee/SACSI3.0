...
with pricing_ranges(building_code, first_no, last_no, area_sqm, price_wan, is_prime, zone_label) as (
  values
    ...
    ('CIMAC-B02', 201, 202, 110, 198, true,  '门口大道区'),
    ('CIMAC-B02', 203, 204,  64, 110, true,  '门口大道区'),
    ('CIMAC-B02', 205, 206,  64, 104, true,  '门口大道区'),
    ('CIMAC-B02', 207, 208,  64,  98, true,  '门口大道区'),
    ('CIMAC-B02', 209, 230,  64,  92, false, '门口大道区'),
    ('CIMAC-B02', 231, 232, 110, 158, false, '门口大道区'),

    ('CIMAC-B03', 301, 302, 110, 188, true,  '门口大道区'),
    ('CIMAC-B03', 303, 304,  64, 104, true,  '门口大道区'),
    ('CIMAC-B03', 305, 306,  64,  98, true,  '门口大道区'),
    ('CIMAC-B03', 307, 308,  64,  92, true,  '门口大道区'),
    ('CIMAC-B03', 309, 326,  64,  86, false, '门口大道区'),
    ('CIMAC-B03', 327, 328, 110, 149, false, '门口大道区'),
