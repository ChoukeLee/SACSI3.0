...
const taxNotes = "\u6765\u6e90\uff1a3\u53f7\u516c\u5bd3.xlsx\uff1bB303\u4e8e2021-04-16\u5b9e\u9645\u6536\u7a0e\u6b3e240\u4e07FCFA\uff1b\u6309Excel\u5b9e\u9645\u91d1\u989d\u767b\u8bb0\uff0c\u4e0d\u53e6\u884c\u8ba1\u7b97\u5dee\u989d\uff0c\u4e0d\u8ba1\u5165\u5408\u540c\u603b\u4ef7\u3002";
...
await checked(supabase.from("audit_logs").insert({ action: "confirm_sacsi3_b303_actual_tax", entity_type: "sale_contract", entity_id: sale.id, metadata: { building_code: "SACSI3", unit_no: "B303", buyer: customer.name, total_xof: 108_000_000, house_payments: [80_000_000, 28_000_000], payment_date: "2021-04-12", settled: true, transfer_tax: { date: "2021-04-16", actual_amount_xof: 2_400_000, difference_tracking: false }, agency: { company: "FULO", paid_date: "2021-12-14", amount_pending: true } } }), "write B303 audit log");
console.log(JSON.stringify({ ok: true, unit: "B303", house_total_xof: 108_000_000, actual_transfer_tax_xof: 2_400_000, settled: true }));
