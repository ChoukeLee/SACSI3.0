...
const saleIds = {
  ...
  "109": await ensureSale("109", songId, { contract_no: "WB-SALE-SACSI4-109-20210808", signed_date: "2021-08-08", transfer_status: "not_started", agency_commission_paid: false, payment_plan_type: "\u5408\u540c\u603b\u4ef76000\u4e07\u5df2\u5305\u542b\u8f66\u4f4d\uff1b\u65e0\u72ec\u7acb\u8f66\u4f4d\u539f\u989d\u62c6\u5206\u4f9d\u636e\uff1b\u56db\u7b14\u6536\u6b3e\u5df2\u7ed3\u6e05\u3002", total_amount_xof: 60_000_000, status: "active" }),
...
async function upsertPayment(spec) {
  ...
  if (rows.length === 0 && spec.oldReceipt) rows = await checked(supabase.from("payments").select("id").eq("source_id", saleIds[spec.unitNo]).eq("receipt_no", spec.oldReceipt), `find old ${spec.oldReceipt}`);
...
const paymentSpecs = [
  ...
  { unitNo: "109", date: "2021-08-08", amount: 24_000_000, receipt: "WB4-SALE-109-20210808-CONTRACT-01", notes: "109\u7b2c\u4e00\u7b14\u5408\u540c\u6b3e2400\u4e07\uff1b\u603b\u4ef7\u5df2\u5305\u542b\u8f66\u4f4d\uff0c\u8f66\u4f4d\u539f\u989d\u65e0\u6cd5\u72ec\u7acb\u62c6\u5206\u3002" },
  { unitNo: "109", date: "2021-08-12", amount: 15_000_000, receipt: "WB4-SALE-109-20210812-CONTRACT-02", notes: "109\u7b2c\u4e8c\u7b14\u5408\u540c\u6b3e1500\u4e07\u3002" },
  { unitNo: "109", date: "2021-08-15", amount: 11_000_000, receipt: "WB4-SALE-109-20210815-CONTRACT-03", notes: "109\u7b2c\u4e09\u7b14\u5408\u540c\u6b3e1100\u4e07\u3002" },
  { unitNo: "109", date: "2021-09-07", amount: 10_000_000, receipt: "WB4-SALE-109-20210907-CONTRACT-04", oldReceipt: "S4-SALE-109-CONSOLIDATED", notes: "109\u7b2c\u56db\u7b14\u5408\u540c\u6b3e1000\u4e07\uff1b\u5df2\u7ed3\u6e05\u3002" },
...
const receivableSpecs = {
  ...
  "109": { total: 60_000_000, notes: "\u5408\u540c\u603b\u4ef76000\u4e07\u5df2\u5305\u542b\u8f66\u4f4d\uff1b\u8f66\u4f4d\u539f\u989d\u65e0\u6cd5\u72ec\u7acb\u62c6\u5206\uff1b\u5df2\u7ed3\u6e05\u3002" },
...
const unitNotes = {
  ...
  "109": "\u4e1a\u4e3b\u5b8b\u7559\u6210\uff1b\u5408\u540c\u603b\u4ef76000\u4e07\u5df2\u5305\u542b\u8f66\u4f4d\uff1b\u4e0e110\u540c\u4e00\u4e1a\u4e3b\uff1b\u5df2\u7ed3\u6e05\u3002",
