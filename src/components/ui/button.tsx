...
const variantStyles = {
  ...
  secondary:
    "bg-white text-brand-ink-800 border border-brand-warm-300 shadow-sm hover:bg-brand-indigo-50 hover:border-brand-indigo-200 active:bg-brand-indigo-100 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-indigo disabled:border-brand-warm-200 disabled:text-brand-ink-400 disabled:scale-100",
  ghost:
    "bg-transparent text-brand-ink-800 hover:bg-brand-indigo-50 hover:text-brand-indigo-800 active:bg-brand-indigo-100 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-indigo disabled:text-brand-ink-400 disabled:scale-100",
  accent:
  ...
  icon: "inline-flex items-center justify-center rounded-lg text-brand-ink-500 hover:bg-brand-indigo-50 hover:text-brand-indigo-700 active:bg-brand-indigo-100 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-indigo disabled:text-brand-ink-400 disabled:scale-100",
} as const;
