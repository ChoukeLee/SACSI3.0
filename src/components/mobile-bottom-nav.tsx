...
export function MobileBottomNav({ locale, userRole: _userRole }: { locale: Locale; userRole?: string }) {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-sticky border-t border-slate-200 bg-white/95 shadow-[0_-10px_30px_-24px_rgba(15,23,42,0.7)] backdrop-blur-xl lg:hidden"
      aria-label="移动端导航"
