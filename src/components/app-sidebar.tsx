    ...
    <Sidebar collapsible="icon" className="border-r border-sidebar-border bg-sidebar">
      <SidebarHeader className="gap-0 border-b border-sidebar-border px-4 h-12 relative">
        <div className="absolute -top-5 left-4 flex items-end gap-3">
          ...
          <span className="text-base font-semibold text-sidebar-foreground whitespace-nowrap pb-[20px]" style={{ fontFamily: "KaiTi, STKaiti, 'AR PL UKai CN', serif" }}>{labels.brand}</span>
        </div>
      </SidebarHeader>
      <SidebarContent>
