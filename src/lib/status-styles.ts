...
export const roomStatusStyles: Record<RoomVisualStatus, StatusVisual> = {
  ...
  leased: {
    ...
    badge: "bg-white text-brand-blue-900 ring-brand-blue-200",
    pill: "border-brand-blue-200 bg-brand-blue-50 text-brand-blue-800",
    dot: "bg-brand-blue-500",
    stripe: "bg-brand-blue-500",
    metric: "border-brand-blue-200 bg-brand-blue-50 text-brand-blue-900",
  },
  dailyOccupied: {
    card: "border-brand-orange-200 bg-brand-orange-50 text-brand-orange-900",
    badge: "bg-white text-brand-orange-900 ring-brand-orange-200",
    pill: "border-brand-orange-200 bg-brand-orange-50 text-brand-orange-800",
    dot: "bg-brand-orange-500",
    stripe: "bg-brand-orange-500",
    metric: "border-brand-orange-200 bg-brand-orange-50 text-brand-orange-900",
  },
  reserved: {
...
export const financeToneStyles = {
  ...
  accent: "border-brand-orange-200 bg-brand-orange-50 text-brand-orange-900",
} as const;
