...
function unitKindLabel(kind: UnitKind, locale: Locale) { const zh = { apartment: "公寓", parking: "车位", storefront: "门面", office: "办公室", warehouse: "仓库" }; const fr = { apartment: "Appartement", parking: "Parking", storefront: "Commerce", office: "Bureau", warehouse: "Entrepôt" }; return (locale === "zh" ? zh : fr)[kind] ?? kind; }
