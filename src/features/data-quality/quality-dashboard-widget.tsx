        ...
        <div className="divide-y divide-neutral-200">
          {top.map(i => (
            <Link
              ...
              className="flex items-center gap-2 px-5 py-2 text-xs transition-colors hover:bg-brand-orange-50/50"
            >
              <AlertTriangle className={cn("h-3.5 w-3.5 shrink-0", i.severity === "high" ? "text-brand-red-500" : "text-brand-orange-500")} />
    ...
    <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-natural">
      ...
      <div className="bg-brand-neutral-50 px-5 py-5">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-2 rounded-2xl border border-neutral-200 bg-white px-4 py-3 shadow-sm">
          <p className="text-[11px] font-bold text-brand-neutral-800">
...
function QualityMetric({
  ...
  const styles = {
    ...
    warning: "border-brand-orange-500 bg-brand-orange-400 text-brand-orange-950 shadow-[0_14px_30px_-22px_rgba(247,127,0,0.58)]",
  ...
  return (
    <div className={cn("min-h-[92px] rounded-2xl border p-3.5", styles)}>
      <div className="flex items-center justify-between gap-2">
        <p className="text-[11px] font-black text-current opacity-90">{label}</p>
