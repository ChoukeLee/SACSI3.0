                  ...
                  {filtered.map(d => (
                    ...
                    >
                      <td className="px-3 py-2">
                        <span className="rounded-full bg-brand-warm-100 px-2 py-0.5 text-[10px] font-bold text-brand-ink-600 ring-1 ring-inset ring-slate-200">
                      ...
                      <td className="px-3 py-2">
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className="rounded p-1 text-brand-ink-400 hover:text-brand-orange hover:bg-brand-warm-50/80"
            ...
            <div className="flex-1 overflow-auto p-4 space-y-3">
              ...
              <div className="border-t border-brand-warm-200 pt-3">
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-brand-orange-500 px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-brand-orange-600 active:scale-[0.98]"
                >
                  <Printer className="h-4 w-4" />{locale === "zh" ? "打印单据" : "Imprimer"}
                </button>
                <p className="mt-1.5 text-[10px] font-semibold text-brand-ink-400 text-center">
