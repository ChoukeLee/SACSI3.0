...
- AI 工作台：自然语言查询、受控操作草稿、人工确认，以及在统一输入框粘贴、拖入或选择图片凭证入账。
...
已完成自然语言只读查询、L1 保洁草稿确认执行、AI 证据链，以及从 AI 对话输入框提交图片/文字凭证进行长租租金和物业费候选提取、人工确认与入账。多轮会话记忆、Excel/PDF 批量导入、语音、合同导入、经营洞察和后台自动化仍在后续范围。
